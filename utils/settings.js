const setting = [
  ...
  },
  {
    setting: {
      ...
      google_id: '',
      google_secret: '',
      github_id: 'Ov23liXLPdnZqMFBQciX',
      github_secret: '571353b22c4fa95dc1d8a3d2eaf01daa7a2cf8d8',
      facebook_id: '',
      facebook_secret: '',
      nextauth_secret: 'gqrb/+CD7y76OblOARgokmthuFgyms7TCrqQwTPRCD8=',
      next_api_base_url: 'http://localhost:5055/api',
      stripe_key:
        'pk_test_51PpbSWCDW7C8yd6if9YW06qUvwVXuPHASlIr2cZZasCneszArYvkzuQi7igbxFEsVtwX8SfnVlNzQBAiYttc7hgX00iKB1i7Kq',
      stripe_secret:
        'sk_test_51PpbSWCDW7C8yd6iK529VOfLXJ1OCvg8KwVKV0lNAUPrCtpFHePupmdtPYVJtzRL4xvnMwxvw3hjQYOhpOUo0QI500UlN61JPu',
      stripe_status: false,
